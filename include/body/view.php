...
<div>
    <form method="POST" action="" id="taskFROM">
        ...
        <div class="row margin-top-10px">
            ...
            <div class="col-md-2"><a href="?page=task"><button type="button" class="btn btn-primary w100p">TaskList</button></a></div>
            <div class="col-md-2"><a href="?page=taskComplete&tid=<?php echo $task->get_taskid(); ?>"><button type="button"  class="btn btn-primary w100p">Complete</button></a></div>
            <div class="col-md-2"><a href="?page=update&tid=<?php echo $task->get_taskid(); ?>"><button type="button"  class="btn btn-primary w100p">Edit</button></a></div>
            <div class="col-md-2"><a href="?page=taskDelete&tid=<?php echo $task->get_taskid(); ?>"><button type="button" class="btn btn-primary w100p">Delete</button></a></div>
            <div class="col-md-2"></div>
        </div>
    </form>
</div>
