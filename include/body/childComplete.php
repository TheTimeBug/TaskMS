<script src="include/assets/js/complete.js"></script>
<?php 
    extract($_REQUEST);
...
<div>
    <form method="POST" action="" id="taskFROM">
        ...
        <div class="row margin-top-10px">
            <div class="col-md-3"></div>
            <div class="col-md-6"><h4 style="text-align: center;">Are you Sure You want to Complete this Task?</h4></div>
            <div class="col-md-3"></div>
        </div>
        <div class="row margin-top-10px">
            <div class="col-md-4"></div>
            <div class="col-md-2"><button type="button"  class="btn btn-primary w100p" onClick="completeCHILD(<?php echo $task->get_childTaskID(); ?>)">Yes</button></div>
            <div class="col-md-2"><a href="?page=childTASK"><button type="button" class="btn btn-primary w100p">No</button></a></div>
            <div class="col-md-4"></div>
        </div>
    </form>
</div>
